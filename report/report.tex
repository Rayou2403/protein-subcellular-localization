...
\title{Protein Subcellular Localization\\Rapport de projet}
\author{Rayane Belkalem \& Moh-Ouali Amrouni}
\date{\today}
...
\begin{itemize}
  ...
  \item choix d'un second embedding plus leger (ProtBert) pour les runs CPU ;
